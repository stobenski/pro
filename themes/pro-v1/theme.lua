...
theme           = {}
theme.icons     = os.getenv("HOME") .. "/.config/awesome/themes/pro-v1/icons/"
theme.wallpaper = os.getenv("HOME") .. "/.config/awesome/themes/pro-v1/wallpapers/v1s.png"
...
-- theme.bg_systray = "#000000" .. 0.01 -- tray fix without patch but with errors in log
