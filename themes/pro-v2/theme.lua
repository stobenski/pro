                ...
                -- [    Pro-v2 theme for Awesome 3.5.5    ] --
                -- [            author: gyrfalco          ] --
...
theme           = {}
theme.icons     = os.getenv("HOME") .. "/.config/awesome/themes/pro-v2/icons/"
theme.wallpaper = os.getenv("HOME") .. "/.config/awesome/themes/pro-v2/wallpapers/v2s.png"
