                ...
                -- [    Pro-v3 theme for Awesome 3.5.5    ] --
                -- [            author: gyrfalco          ] --
...
theme           = {}
theme.icons     = os.getenv("HOME") .. "/.config/awesome/themes/pro-v3/icons/"
theme.wallpaper = os.getenv("HOME") .. "/.config/awesome/themes/pro-v3/wallpapers/v3s.png"
